    ...
    <div id="wpestate_sidebar_menu">
        <div id="general_settings_sidebar" class="theme_options_sidebar">
            <ul>
                ...
                <li data-optiontab="user_role_options_tab"   class="">'.__('User Role Settings','wpestate').'</li>
        ...
        <div id="social_contact_sidebar" class="theme_options_sidebar" style="display:none;">
            <ul>
                ...
                <li data-optiontab="social_login_tab" class="">'.__('Social Login','wpestate').'</li>
                <li data-optiontab="contact7_tab" class="">'.__('Contact 7 Settings','wpestate').'</li>
                <li data-optiontab="twitter_widget_tab" class="">'.__('Twitter Widget','wpestate').'</li>
            </ul>
        </div>
        ...
        <div id="advanced_search_settings_sidebar" class="theme_options_sidebar" style="display:none;">
            <ul>
                ...
                <li data-optiontab="save_search_tab" class="">'.__('Save Search Settings ','wpestate').'</li>
                <li data-optiontab="advanced_search_colors_tab" class="">'.__('Advanced Search Colors','wpestate').'</li>
            </ul>
        </div>
    ...
    print ' <div id="wpestate_wrapper_admin_menu"> 
                <div id="general_settings_sidebar_tab" class="theme_options_wrapper_tab">
                    ...
                    <form method="post" action="" >
                        <div id="user_role_options_tab" class="theme_options_tab" style="display:none;">
                            <h1>'.__('User Role Settings','wpestate').'</h1>
                            <input type="submit" name="submit"  class="new_admin_submit new_admin_submit_right" value="'.__('Save Changes','wpestate').'" />
                            <div class="theme_option_separator"></div>';    
                ...
                <div id="social_contact_sidebar_tab" class="theme_options_wrapper_tab" style="display:none">
                        ...
                        <div id="social_login_tab" class="theme_options_tab" style="display:none;">
                            <h1>'.__('Social Login ','wpestate').'</h1>
                            <input type="submit" name="submit"  class="new_admin_submit new_admin_submit_right" value="'.__('Save Changes','wpestate').'" />
                            <div class="theme_option_separator"></div>';
                        ...
                        <div id="twitter_widget_tab" class="theme_options_tab" style="display:none;">
                            <h1>'.__('Twitter Widget','wpestate').'</h1>
                            <input type="submit" name="submit"  class="new_admin_submit new_admin_submit_right" value="'.__('Save Changes','wpestate').'" />
                            <div class="theme_option_separator"></div>';
                ...
                <div id="advanced_search_settings_sidebar_tab" class="theme_options_wrapper_tab"  style="display:none">
                        ...
                        <div id="save_search_tab" class="theme_options_tab" style="display:none;">
                            <h1>'.__('Save Search Settings','wpestate').'</h1>
                            <input type="submit" name="submit"  class="new_admin_submit new_admin_submit_right" value="'.__('Save Changes','wpestate').'" />
                            <div class="theme_option_separator"></div>';
                        ...
                        <div id="advanced_search_colors_tab" class="theme_options_tab" style="display:none;">
                            <h1>'.__('Advanced Search Colors','wpestate').'</h1>
                            <input type="submit" name="submit"  class="new_admin_submit new_admin_submit_right" value="'.__('Save Changes','wpestate').'" />
                            <div class="theme_option_separator"></div>';
...
function wpestate_theme_admin_user_role_settings(){
    ...
    $wp_estate_show_reviews_out    =   array( 'agent' => __('Agent','wpestate') , 'agency' => __('Agency','wpestate'),  'developer' => __('Developer','wpestate') );
    
    $wp_estate_show_reviews     =    get_option('wp_estate_show_reviews_block','');
 
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Select Taxonomies, where you want to show review block','wpestate').'</div>
    <div class="option_row_explain">'.__('*Hold CTRL for multiple selection.','wpestate').'</div>    
...
function new_wpestate_header_settings(){
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Show top bar on mobile devices?','wpestate').'</div>
    <div class="option_row_explain">'.__('Enable or disable top bar on mobile devices','wpestate').'</div>    
...
function new_wpestate_price_currency(){
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Enable auto loading of exchange rates from free.currencyconverterapi.com (1 time per day)?','wpestate').'</div>
...
function new_wpestate_membership_settings(){
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Maximum no of images per property (only front-end upload). Works when submission is free or requires user to pay a fee for each listing','wpestate').'</div>
    <div class="option_row_explain">'.__('The maximum no of images a user can upload with the front end submit form. Use 0 for unlimited. This value is NOT used in case of membership mode (each package will have its own max image no set)','wpestate').'</div>    
...
function     new_wpestate_paypal_settings(){
    ...
    <div class="option_row_explain">'.__('Info is taken from https://www.paypal.com/ or http://sandbox.paypal.com/ See help.','wpestate').'</div>    
     ...
     $paypal_api_username            =   esc_html( get_option('wp_estate_paypal_api_username','') );
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Paypal Api User Name - Obsolete starting 1.30.1','wpestate').'</div>
    <div class="option_row_explain">'.__('Info is taken from https://www.paypal.com/ or http://sandbox.paypal.com/ See help.','wpestate').'</div>    
    ...
    $paypal_api_password            =   esc_html( get_option('wp_estate_paypal_api_password','') );
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Paypal API Password - Obsolete starting 1.30.1','wpestate').'</div>
    <div class="option_row_explain">'.__('Info is taken from https://www.paypal.com/ or http://sandbox.paypal.com/ See help.','wpestate').'</div>    
    ...
    $paypal_api_signature           =   esc_html( get_option('wp_estate_paypal_api_signature','') );
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Paypal API Signature - Obsolete starting 1.30.1','wpestate').'</div>
    <div class="option_row_explain">'.__('Info is taken from https://www.paypal.com/ or http://sandbox.paypal.com/ See help.','wpestate').'</div>    
...
function    new_wpestate_advanced_search_form(){
    ...
    <div class="option_row_explain">'.__('Works with "Use FLoat Form" options set to no ! Doesn\'t apply to search type 3.','wpestate').'</div>    
    ...
    <div class="option_row_explain">'.__('This will replace the sticky header.  Doesn\'t apply to search type 3','wpestate').'</div>    
    ...
    <div class="option_row_explain">'.__('The search form is "floating" over the media header and you set the position.','wpestate').'</div>    
...
if( !function_exists('new_wpestate_advanced_search_settings') ):  
 function new_wpestate_advanced_search_settings(){
    ...
    <div class="option_row_explain">'.__('This applies for the search over header type. IMPORTANT! Enable Advanced Search Custom Fields - YES, for Type 5, Type 6, Type 8, Type 10 and Type 11. Types 7 & 9 look can be obtained with type 6 and 8 with float form set to yes.','wpestate').'</div>    
...
function new_wpestate_property_links(){
    ...
    $links_to_rewrite = array(
        ...
        'action_category_agency'     =>  array(
                                         $rewrites[13],
                                        __('Agency Action Category Page','wpestate')
                                    ),
        'city_agency'     =>  array(
                                         $rewrites[14],
                                        __('Agency City Page','wpestate')
                                    ),
        'area_agency'     =>  array(
                                         $rewrites[15],
                                        __('Agency Area Page','wpestate')
                                    ),
        ...
        'single_page_agency'     =>  array(
                                         $rewrites[22],
                                        __('Agency Page','wpestate')
                                    ),
        'single_page_developer'     =>  array(
                                         $rewrites[23],
                                        __('Developer Page','wpestate')
                                    ),
    );
...
if( !function_exists('new_wpestate_theme_slider') ):   
 ...
 function new_wpestate_email_management(){
        ...
        foreach ($emails as $key=>$label ){
            ...
            <div class="option_row_explain">'.__('Email subject for','wpestate').' '.$label.'</div>
            ...
            <div class="option_row_explain">'.__('Email content for','wpestate').' '.$label.'</div>';
...
//    </div>';
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Yelp Api  Client Id','wpestate').'</div>
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Yelp Api Client Key','wpestate').'</div>
    <div class="option_row_explain">'.__('Get this detail after you signup here ','wpestate').'<a target="_blank" href="https://www.yelp.com/developers/v3/manage_app">https://www.yelp.com/developers/v3/manage_app</a></div>    
...
function new_wpestate_property_list_design_details(){
    ...
    $cache_array =   array(   0 =>__('default','wpestate'),
                                ...
                                3 =>__('type 3','wpestate'), 
                                4 =>__('type 4','wpestate'),
                            );
