    ...
    if( !function_exists('wpestate_vc_shortcodes')):
            ...
            array(
                ...
                "params" => array(
                    ...
                    array(
                        ...
                        "value" => "",
                        "description" => __("Add the ID of the property you want to show","wpestate")
                    ),
        ...
        vc_map(
            array(
                ...
                "params" => array(
                   ...
                   array(
                        ...
                        "holder" => "div",
                        "class" => "",
                        "heading" => __("Type Agent name","wpestate"),
                        "param_name" => "agentid",
                        "value" => "",
                        "description" => __("Select one Agent","wpestate"),
						'settings' => array(
								'multiple' => false,
								'sortable' => true,
								'min_length' => 1,
             ...
             vc_map( array(
                ...
                "params" => array(
                    array(
                        ...
                        "holder" => "div",
                        "class" => "",
                        "heading" => esc_html__( "Type Categories,Actions,Cities,Areas,Neighborhoods or County name you want to show","wpestate"),
                        "param_name" => "place_list",
                        "value" => "",
                        "description" => esc_html__( "Type Categories,Actions,Cities,Areas,Neighborhoods or County name you want to show","wpestate"),
                        'settings' => array(
                            'multiple' => true,
                            'sortable' => true,
                            'min_length' => 1,
            ...
            array(
               ...
               "params" => array(
                   ...
                   array(
                     ...
                     "holder" => "div",
                     "class" => "",
                     "heading" => __("Type Category names","wpestate"),
                     "param_name" => "category_ids",
                     "value" => "",
                     "description" => __("list of agent category names","wpestate"),
					 'settings' => array(
						'multiple' => true,
						'sortable' => true,
						'min_length' => 1,
                     ...
                     "holder" => "div",
                     "class" => "",
                     "heading" => __("Type Action names","wpestate"),
                     "param_name" => "action_ids",
                     "value" => "",
                     "description" => __("list of agent action names","wpestate"),
					 'settings' => array(
						'multiple' => true,
						'sortable' => true,
						'min_length' => 1,
                   ...
                   array(
                     ...
                     "holder" => "div",
                     "class" => "",
                     "heading" => __("Type City names","wpestate"),
                     "param_name" => "city_ids",
                     "value" => "",
                     "description" => __("list of agent city names","wpestate"),
					 'settings' => array(
						'multiple' => true,
						'sortable' => true,
						'min_length' => 1,
                    ...
                    array(
                     ...
                     "holder" => "div",
                     "class" => "",
                     "heading" => __("Type Area names","wpestate"),
                     "param_name" => "area_ids",
                     "value" => "",
                     "description" => __("list of agent area names","wpestate"),
					 'settings' => array(
						'multiple' => true,
						'sortable' => true,
						'min_length' => 1,
              ...
              vc_map(
                   ...
                   "params" => array(
                       array(
                            ...
                            "holder" => "div",
                            "class" => "",
                            "heading" => __("Type Package name","wpestate"),
                            "param_name" => 'package_id',
                            "value" => "",
                            "description" => __("Select only one Package","wpestate"),
							'settings' => array(
								'multiple' => false,
								'sortable' => true,
								'min_length' => 1,
                    ...
                    "params" => array(
                        array(
                            ...
                            "holder" => "div",
                            "class" => "",
                            "heading" => __("Type Agency or Developer name","wpestate"),
                            "param_name" => 'user_role_id',
                            "value" => "",
                            "description" => __("Select one Agency or Developer","wpestate"),
							'settings' => array(
								'multiple' => false,
								'sortable' => true,
								'min_length' => 1,
               ...
               "params" => array(
                  ...
                  array(
                    ...
                    array(
                     ...
                     "holder" => "div",
                     "class" => "",
                     "heading" => __("List of terms for the filter bar (*applies only for properties, not articles/posts)","wpestate"),
                   ...
                   array(
                    ...
                    array(
                       ...
                       "holder" => "div",
                       "class" => "",
                       "heading" => __("Type County/State names","wpestate"),
                       "param_name" => "state_ids",
                       "value" => "",
                       "description" => __("list of county/State ids separated by comma (*only for properties)","wpestate"),
                       "dependency" => array(
            ...
            vc_map(
               ...
               "params" => array(
                  array(
                     ...
                     "holder" => "div",
                     "class" => "",
                     "heading" => __("Type article name","wpestate"),
                     "param_name" => "id",
                     "value" => "",
                     "description" => __("Select one article","wpestate"),
					 'settings' => array(
						'multiple' => false,
						'sortable' => true,
						'min_length' => 1,
                    ...
                    array(
                        ...
                        "holder" => "div",
                        "class" => "",
                        "heading" => __("Featured text (for type1)","wpestate"),
                        "param_name" => "second_line",
                        "value" => "",
                        "description" => __("featured text","wpestate")
                   ),
                    array(
                        ...
                        "description" => __("type 1 or 2","wpestate")
                  )    
               )
            )
            );
                  ...
                  array(
                   ...
                   array(
                    ...
                    array(
                     ...
                     "description" => __("type 1, 2, 3 or 4","wpestate")
                  )    
               )
            )
            );
			...
			// reproces autocomplete
                ...
                vc_map( array(
                "name" => esc_html__( "Display Places Slider","wpestate"),//done
                "base" => "places_slider",
                "class" => "",
                "category" => esc_html__( 'Content','wpestate'),
                'admin_enqueue_js' => array(get_template_directory_uri().'/vc_extend/bartag.js'),
                ...
                'weight'=>100,
                'icon'   =>'wpestate_vc_logo',
                'description'=>esc_html__( 'Display Places Slider','wpestate'),  
                "params" => array(
