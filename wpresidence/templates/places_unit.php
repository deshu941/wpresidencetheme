...
<div class="<?php echo esc_html($col_class);?> listing_wrapper" data-org="<?php echo esc_html($col_org);?>" data-listid="<?php echo intval($post->ID);?>" > 
    <div class="property_listing places_listing" data-link="<?php echo esc_url($term_link);?>" >
        ...
        <div class="property_location">
            <?php 
            echo esc_html($category_count).' '.__('Listings','wpestate' );
            $protocol = is_ssl() ? 'https' : 'http';
            ?>                    
            <div class="listing_actions">
                               
                    <div class="share_unit">
                        <a href="<?php echo $protocol;?>://www.facebook.com/sharer.php?u=<?php echo esc_url($term_link); ?>&amp;t=<?php echo urlencode($category_name); ?>" target="_blank" class="social_facebook"></a>
                        <a href="<?php echo $protocol;?>://twitter.com/home?status=<?php echo urlencode($category_name.' '.$term_link); ?>" class="social_tweet" target="_blank"></a>
                        <a href="<?php echo $protocol;?>://plus.google.com/share?url=<?php echo esc_url($term_link); ?>" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" target="_blank" class="social_google"></a> 
                        <a href="<?php echo $protocol;?>://pinterest.com/pin/create/button/?url=<?php echo esc_url($term_link); ?>&amp;media=<?php if (isset( $category_featured_image_url)){ echo esc_url($category_featured_image_url); }?>&amp;description=<?php echo urlencode($category_name); ?>" target="_blank" class="social_pinterest"></a>
                    </div>
