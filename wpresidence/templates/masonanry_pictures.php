<div class="gallery_wrapper">
    ...
    foreach ($post_attachments as $attachment) {
        ...
        if($count <= 4 && $count !=0){
            ...
            print '<div class="col-md-4 image_gallery lightbox_trigger '.$special_border.' " data-slider-no="'.($count+1).'" style="background-image:url('.$full_prty[0].')"> <div class="img_listings_overlay" ></div> </div>';
        }


        if($count ==5 ){
            $full_prty          = wp_get_attachment_image_src($attachment->ID, 'listing_full_slider');
            print '<div class="col-md-4 image_gallery last_gallery_item lightbox_trigger" data-slider-no="'.($count+1).'" style="background-image:url('.$full_prty[0].')  ">
