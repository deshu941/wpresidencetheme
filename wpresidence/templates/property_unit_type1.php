         ...
         wpestate_build_unit_custom_structure($custom_unit_structure,$post->ID,$property_unit_slider);
            ...
            <div class="property_details_type1_wrapper">
                ...
                <?php 
                    ...
                    if($property_size!=''){
                        print ' <span class="property_details_type1_size">'.__('Size:','wpestate').'</span>'.'<span class="property_details_type1_value">'.$property_size.'</span>';
                    }
                     if($prop_id !=''){
            ...
            <div class="property_location"> 
                ...
                <div class="property_agent_wrapper">
                    ...
                    <?php 
                     echo'<span><strong>'. __('Agent','wpestate').':'.'</strong></span>';
                    if($agent_id!=0){
