...
<div class="add-estate profile-page profile-onprofile row"> 
    ...
    <div class="col-md-8">
        ...
        <?php
            ...
            echo '<p style="height:50px;">'.__('Username:','wpestate').' '.$user_for_agent->user_login.' '.__('is not editable','wpestate').'</p>';
        } 
        ?>
    </div>
...
<div class="add-estate profile-page profile-onprofile row">
   ...
   <div class="col-md-8 add_custom_data_cont">
		<div class="row">
			<button type="button" class="wpresidence_button add_custom_parameter"  ><?php _e('Add Custom Field','wpestate');?></button>
		...
		<div class="row single_parameter_row cliche_row">
				<div class="col-md-5">
					<p>
						<label for="agent_custom_label"><?php _e('Parameter Label','wpestate');?></label>
						<input type="text"  class="form-control agent_custom_label" value=""  name="agent_custom_label[]">
					</p>
				</div>
				<div class="col-md-5">
					<p>
						<label for="agent_custom_value"><?php _e('Parameter Value','wpestate');?></label>
				...
				<div class="col-md-2">
					<p>
						<br/>
						<button type="button" class="wpresidence_button remove_parameter_button"  ><?php _e('Remove','wpestate');?></button>
					</p>
				</div>
