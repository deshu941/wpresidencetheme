    ...
    <div class="message_listing " data-messid="<?php print $post->ID; ?> ">
        ...
        <div class="mess_content">
            ...
            <div class="message_content">
                ...
                <span class="wpresidence_button  mess_send_reply_button2"><?php _e('Reply','wpestate');?></span>
        ...
        <div class="mess_reply_form">
                ...
                <span class="wpresidence_button  mess_send_reply_button"  data-messid="<?php echo $post->ID;?>">
