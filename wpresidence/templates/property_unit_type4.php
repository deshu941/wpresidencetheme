...
<div class="<?php echo esc_html($col_class);?> listing_wrapper property_unit_type4 " data-org="<?php echo esc_html($col_org);?>" data-listid="<?php echo intval($post->ID);?>" > 
    <div class="property_listing property_unit_type4 <?php if($wpestate_uset_unit==1) print 'property_listing_custom_design' ?> " data-link="<?php   if(  $property_unit_slider==0){ echo esc_url($link);}?>">
        ...
        <?php if ($wpestate_uset_unit==1){
         ...
         wpestate_build_unit_custom_structure($custom_unit_structure,$post->ID,$property_unit_slider);
            ...
            if ( has_post_thumbnail() ){
                ...
                $property_bathrooms     =   get_post_meta($post->ID, 'property_bedrooms', true) ;
            ...
            <div class="property_listing_details">
                ...
                <?php 
                    if($property_rooms!=''){
                        print '<div class="inforoom_unit_type4">'.__('Rooms','wpestate').'<span>'.$property_rooms.'</span></div>';
                    }

                    if($property_bathrooms!=''){
                        print '<div class="infobath_unit_type4">'.__('Bedrooms','wpestate').'<span>'.$property_bathrooms.'</span></div>';
                    }
                    
                    if($property_size!=''){
                        print '<div class="infosize_unit_type4">'.__('Size','wpestate').'<span>'.$property_size.'</span></div>';
                    }
        ...
        <div class="property_listing_details4_grid_view">
            <?php
            if($property_bathrooms!=''){
                print '<div class="infobath_unit_type4">'.$property_bathrooms.' '.__('Bedrooms','wpestate').'</div>';
            }
            
            if($property_size!=''){
                print '<div class="infosize_unit_type4">'.$property_size.'</div>';
            }
            ...
            <div class="property_agent_unit_type4">
                    ...
                    <div class="propery_price4_grid">
                        <?php  wpestate_show_price($post->ID,$currency,$where_currency);?>
                    </div>
                    ...
                    <div class="property_agent_wrapper">
                        <?php echo '<a href="'.get_permalink($agent_id).'">' ?>
